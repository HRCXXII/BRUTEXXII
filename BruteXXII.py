...
\033[1;97m➤ \033[1;92mTool BruteX is created by MrHRCXXII
\033[1;92m""")
...
# main script start
os.system("xdg-open https://www.youtube.com/@hrcreator22")
time.sleep(5)
...
while True:
        ...
        if menu == '01' or menu == '1':
                ...
                while True:
                        ...
                        if fol == '1' or fol == '01':
                                print()
                                print("\033[1;91m[*] \033[1;97mOpening my Youtube \n")
                                time.sleep(1)
                                os.system("xdg-open https://www.youtube.com/@hrcreator22")
